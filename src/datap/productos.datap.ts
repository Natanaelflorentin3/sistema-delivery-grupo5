...
import type { productos } from "../typesp/productos.types.js";
import type productosTypes = require("../typesp/productos.types.js");
...
export async function cargarDatos() {
  try {
    ...
    console.log(
      `DATOS CARGADOS EN MEMORIA: ${listaproductos.length} productos cargados`,
    );
  } catch (error) {
